...
<web-app xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:web="http://java.sun.com/xml/ns/javaee" xsi:schemaLocation="http://java.sun.com/xml/ns/javaee http://java.sun.com/xml/ns/javaee/web-app_2_5.xsd" id="WebApp_ID" version="2.5">
  <display-name>RTB Dashboard</display-name>
  <filter>
  ...
  <servlet>
    ...
    <servlet-class>rtb.servlets.GenerateJasperReport</servlet-class>
  </servlet>
  <servlet-mapping>
    <servlet-name>GenerateJasperReport</servlet-name>
  ...
  <servlet>
    <description></description>
    <display-name>ApiDailyExchangerCostAnalysisByHour</display-name>
    <servlet-name>ApiDailyExchangerCostAnalysisByHour</servlet-name>
    <servlet-class>rtb.servlets.ApiDailyExchangerCostAnalysisByHour</servlet-class>
  </servlet>
  <servlet-mapping>
    <servlet-name>ApiDailyExchangerCostAnalysisByHour</servlet-name>
    <url-pattern>/api/v1/dailyExchangeCostAnalysisByHour</url-pattern>
  </servlet-mapping>
  <servlet>
    <description></description>
    <display-name>ApiDailyExchangerCostAnalysis</display-name>
    <servlet-name>ApiDailyExchangerCostAnalysis</servlet-name>
    <servlet-class>rtb.servlets.ApiDailyExchangerCostAnalysis</servlet-class>
  </servlet>
  <servlet-mapping>
    <servlet-name>ApiDailyExchangerCostAnalysis</servlet-name>
    <url-pattern>/api/v1/dailyExchangeCostAnalysis</url-pattern>
  </servlet-mapping>
  <servlet>
    <description></description>
    <display-name>ApiDailyWinRate</display-name>
    <servlet-name>ApiDailyWinRate</servlet-name>
    <servlet-class>rtb.servlets.ApiDailyWinRate</servlet-class>
  </servlet>
  <servlet-mapping>
    <servlet-name>ApiDailyWinRate</servlet-name>
    <url-pattern>/api/v1/dailyWinRate</url-pattern>
  </servlet-mapping>
  <servlet>
    <description></description>
    <display-name>ApiDailyWinRateByHour</display-name>
    <servlet-name>ApiDailyWinRateByHour</servlet-name>
    <servlet-class>rtb.servlets.ApiDailyWinRateByHour</servlet-class>
  </servlet>
  <servlet-mapping>
    <servlet-name>ApiDailyWinRateByHour</servlet-name>
