...
import rtb.api.DailyWinRateByHour;
import rtb.api.QueryApi;
import rtb.bean.ApiResponseResultSet;
import rtb.bean.ApiResponseResultSetInfo;

/**
 * Servlet implementation class ApiDailyWinRateByHour
 */
public class ApiDailyWinRateByHour extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ApiDailyWinRateByHour() {
        super();
