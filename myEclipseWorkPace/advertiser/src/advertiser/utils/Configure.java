...
public class Configure {
	...
	public static String getConfig(String param) {
		...
		try {
			...
			properties.load(loader.getResourceAsStream("advertiser/utils/config.properties"));
	...
	public static Properties getProperties(){
		...
		try {
			ClassLoader loader = Configure.class.getClassLoader();	
			InputStream is=loader.getResourceAsStream("advertiser/utils/config.properties");
			properties.load(is);
			is.close();
