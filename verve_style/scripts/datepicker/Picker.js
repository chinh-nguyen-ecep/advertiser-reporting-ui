...
var Picker = new Class({
	...
	constructPicker: function(){
		...
		picker.setStyle('width',options.width);
		picker.setStyle('height',options.height);
		picker.setStyle('z-index',options.zindex);
		...
		this.closeButton = new Element('div.closeButton')
		...
		body.setStyle('width',options.width);
		body.setStyle('height',options.height-37);
