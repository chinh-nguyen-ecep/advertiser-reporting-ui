...
my $emailNoticeTitle="[Notification!][Event tracker report][May be late today][$date]";
my $emailAvailableTitle="[Notification!][Event tracker report][Available][$date]";
my $mailto="dw-vndev\@ecepvn.org,chinh.nguyen\@ecepvn.org";
my $contentTitle="Agg data for Event Tracker report on dw3 on date: $date ";
my $resultHTML="";
