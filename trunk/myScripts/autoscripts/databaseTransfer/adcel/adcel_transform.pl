...
my $daily_agg_table="daily_adcel_agg_table.txt";
...
if(@ARGV==4){
	...
	print "perl adcel_transform.pl daily dw4 dw3 2012-02-01\n";
	print "perl adcel_transform.pl daily_fact dw4 dw3 eastern_date_sk\n";
	print "perl adcel_transform.pl monthly dw4 dw3 2012-Mar\n";
}
sub checkDailyAgg{
	my $from=shift;
	my $to=shift;
