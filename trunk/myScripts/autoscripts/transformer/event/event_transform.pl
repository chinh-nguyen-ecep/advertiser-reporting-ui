...
my $daily_agg_table="daily_event_agg_table.txt";
my $daily_fact_table="daily_event_fact_table.txt";
my @aggTable=();
my @factTable=();
...
if(@ARGV==4){
	...
	print "perl event_transform.pl daily dw4 dw3 2012-02-01\n";
	print "perl event_transform.pl daily_fact dw4 dw3 eastern_date_sk\n";
	print "perl event_transform.pl monthly dw4 dw3 2012-Mar\n";
}
sub checkDailyAgg{
	my $from=shift;
	my $to=shift;
