...
import rtb.api.DailyWinRateExchangeBidprice;
 ...
 */
public class ApiDailyWinRateExchageBidprice extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ApiDailyWinRateExchageBidprice() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		api=new DailyWinRateExchangeBidprice();
		//get info param
