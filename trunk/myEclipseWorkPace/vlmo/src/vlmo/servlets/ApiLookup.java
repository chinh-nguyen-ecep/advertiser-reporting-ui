...
import vlmo.core.QueryApi;

/**
 * Servlet implementation class ApiLookup
 */
public class ApiLookup extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			c = Class.forName("vlmo.api.lookup."+apiClass);
