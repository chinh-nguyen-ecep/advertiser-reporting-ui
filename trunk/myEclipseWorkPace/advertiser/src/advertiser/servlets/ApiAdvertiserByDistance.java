...
import advertiser.api.AdvertiserByDistance;
import advertiser.api.QueryApi;
import advertiser.bean.ApiResponseResultSet;
import advertiser.bean.ApiResponseResultSetInfo;

/**
 * Servlet implementation class ApiAdvertiserCreativesByDistance
 */
public class ApiAdvertiserByDistance extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ApiAdvertiserByDistance() {
        super();
