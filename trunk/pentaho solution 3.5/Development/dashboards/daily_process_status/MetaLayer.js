...
MetaLayer = {
	...
	loadETLStatus: function(dom,group_process,full_date,host,data_file_ids){
	var ajaxURL=pentahoActionURL( rootLocate, locate, "CheckLogFileStatus.xaction");
		//adcel
			var a=$.ajax({
			  url: ajaxURL,
			  dataType: 'html',
			  data: {'full_date':full_date,'group_process':group_process,'p_server':host,'data_file_ids':data_file_ids},
			  beforeSend: function(){
				dom.empty();
				var loadingNote='<tr><td colspan="8" style="text-align: left"><img src="/verve_style/images/loading.gif" /></td></tr>';
